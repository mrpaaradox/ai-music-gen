...
export function SongCard({song}: {song: SongWithRelatiom}){
    ...
    return (
        <div>
            ...
            >
                <div
                className="group relative aspect-square w-full overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75"
                >
                    {song.thumbnailUrl ? (
                        <Image
                    ...
                    <div
                    className="mt-1 flex items-center justify-between text-xs text-gray-900"
                    >
                        <span>
